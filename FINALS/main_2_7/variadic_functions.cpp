// 7.	https://www.hackerrank.com/challenges/variadic-functions-in-c/problem
...
int  sum(int count, ...) {
	...
	va_start(list_numbers, count);
	for (int i = 0; i < count; i++)
		suma += va_arg(list_numbers, int);
	va_end(list_numbers);
	return suma;
}
